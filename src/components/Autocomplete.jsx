    ...
    return (
        <div className="relative">
            <input
                ...
                className="cursor-pointer w-full p-2 rounded-lg border-solid border-[2px] border-black"
                type="text"
            ...
            <div className='w-full flex flex-wrap content-start p-2 gap-2 mt-4 h-12 overflow-y-scroll rounded-lg border-solid border-[2px]'>
                {
                    state.map((data, index) => {
                        return (
                            <div className='w-fit flex items-center gap-2 px-2 border-solid border-black border-[2px] rounded-lg' key={index + 1}>
                                {data}
                                <div
